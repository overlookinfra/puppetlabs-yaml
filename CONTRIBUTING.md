...
module. When you run tests for this module, it will expect this module to be
saved to a directory named `ruby_task_helper` at the same location as this
module's directory. This directory structure looks similar to this:
...
- [Open an
  issue](https://github.com/puppetlabs/puppetlabs-yaml/issues/new/choose)
  or [track an
  issue](https://github.com/puppetlabs/puppetlabs-yaml/issues) you are
  patching.
...
- [Open a Pull
  Request](https://github.com/puppetlabs/puppetlabs-yaml/compare)
